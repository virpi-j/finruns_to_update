...
if(!exists("HcFactorAll")) HcFactorAll <- rep(1,19)#c(1.2,0.8,0.8,1.2,1.2,0.8,1.2,1.2,0.8,
...
startingYear = 2015
endingYear = 2050
if(exists("nYears")) endingYear <- startingYear + nYears 
if(!exists("nYears")) nYears = endingYear-startingYear
if(!exists("yearsToMem")) yearsToMem <- c(30,50,70) # For HiiliKartta, the initial ages to memory
